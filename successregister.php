...
if($_SESSION['fromSignup'] != "true"){
	...
	exit;
			...
			$sql = "INSERT INTO clients VALUES ('$username','$password','null','null','null','null','0','NULL','$fullname','$date_of_application','$address','$occupation','$telephone','$birthday',
	...
	if($rates != 'regular'){
		mysqli_query($connection, "UPDATE clients SET membership='$membership', staff_register='$staff', date_of_membership='$date_of_membership',rates='$rates',date_of_promos='$date_of_promos'
		...
		mysqli_query($connection, "UPDATE clients SET membership='$membership', date_of_membership='$date_of_membership', staff_register=null, rates=null, date_of_promos=null
		WHERE username='$username'");
